...
const SOURCE_REGISTRY = [
  ...
  { id: 'goUpc',                 name: 'Go-UPC Global',            description: 'International product database (may require auth)',            type: 'product',    region: 'global',   defaultEnabled: true, requiresKey: false, icon: '🌐' },
  ...
  { id: 'productWorld',          name: 'Product World DB',         description: 'Multi-source free barcode database (Round 30 replacement)',    type: 'product',    region: 'global',   defaultEnabled: true, requiresKey: false, icon: '🌍' },

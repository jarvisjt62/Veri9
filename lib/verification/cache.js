...
const ENGINE_VERSION = 12; // Round 28b — Tier 1 free sources expansion: Open Products Facts (non-food consumer goods), Open Pet Food Facts, Wikidata SPARQL (authoritative cross-references), Health Canada Recalls (Canadian coverage)

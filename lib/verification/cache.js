...
const ENGINE_VERSION = 11; // Round 28 — Smarter trust score (FDA conditional, enrichment factor, confidence floor), recall variant exclusion + terminated-status filter, verdict precedence fix, UNREADABLE score=0, known-test-barcode detection
